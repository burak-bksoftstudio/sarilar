      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <select
            ...
            name="position"
            required
            className="w-full px-4 py-3 rounded-lg border border-slate-300 focus:border-gold focus:ring-2 focus:ring-gold/20 outline-none transition-colors bg-white"
          >
            <option value="">Seçiniz...</option>
            <option value="sales">Satış Temsilcisi</option>
            <option value="warehouse">Depo Görevlisi</option>
        ...
        <div>
          ...
          <div className="border-2 border-dashed border-slate-300 rounded-lg p-6 text-center hover:border-gold transition-colors cursor-pointer">
            <input
              type="file"
              id="cv"
              name="cv"
